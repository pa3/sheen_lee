...
public class Boss3KnockOutState implements State {
    ...
    public function Boss3KnockOutState(me:AIPlayer) {
        reset(me);
    }

    public static function newInstance(me:AIPlayer):Boss3KnockOutState {

        if (_pool.length > 0) {
            var result:Boss3KnockOutState = _pool.shift();
            result.reset(me);
            return result;
        } else {
            return new Boss3KnockOutState(me);
        }
    }

    public static function release(state:Boss3KnockOutState):void {
        _pool.push(state);
    }
    ...
    public function exit():void {
        Boss3KnockOutState.release(this);
    }
