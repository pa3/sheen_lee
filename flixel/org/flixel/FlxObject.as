package org.flixel
{
	...
	public class FlxObject extends FlxRect
	{
		...
		protected var _flickerPeriod:Number;
		
		protected var _flickerPeriodTimer:Number;
		...
		protected function updateFlickering():void
		{
			if(flickering())
			{
				...
				{
					_flickerPeriodTimer = _flickerPeriodTimer - FlxG.elapsed;
					if (_flickerPeriodTimer < 0) {
						_flicker = !_flicker;
						visible = !_flicker;
						_flickerPeriodTimer = _flickerPeriod;
					}
				}
			}
		}
		 ...
		 */
		public function flicker(Duration:Number=1, Period:Number=0.2):void { _flickerTimer = Duration; _flickerPeriodTimer = _flickerPeriod = Period; if(_flickerTimer < 0) { _flicker = false; visible = true; } }
